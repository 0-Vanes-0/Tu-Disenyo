...
fun debugColors(darkTheme: Boolean, debugColor: Color = Color.Magenta) = ColorScheme(
    primary = Lavender7,
    onPrimary = Lavender10,
    primaryContainer = Lavender1,
    onPrimaryContainer = Lavender3,
    inversePrimary = debugColor,
    secondary = Lavender7,
    onSecondary = Lavender10,
    secondaryContainer = Lavender1,
    onSecondaryContainer = Lavender3,
    tertiary = debugColor,
    ...
    surface = Neutral0,
    onSurface = Neutral6,
    surfaceVariant = Ocean1,
    onSurfaceVariant = Ocean9,
    surfaceTint = Neutral2,
